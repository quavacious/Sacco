<!DOCTYPE html>
<html lang="en">
<!-- Mirrored from themesdesign.in/zinzer_1/horizontal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2019 08:43:47 GMT -->
...
<body>
                ...
                <div class="container-fluid">
                    <div id="navigation">
                        ...
                        <ul class="navigation-menu">
                            <li class="has-submenu"><a href="index.html"><i class="dripicons-home"></i> Dashboard</a></li>
                            <li class="has-submenu"><a href="#"><i class="dripicons-suitcase"></i> User Interface <i class="mdi mdi-chevron-down mdi-drop"></i></a>
                            ...
                            <li class="has-submenu"><a href="#"><i class="dripicons-help"></i> Components <i class="mdi mdi-chevron-down mdi-drop"></i></a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu"><a href="#"><i class="dripicons-archive"></i> Advanced UI <i class="mdi mdi-chevron-down mdi-drop"></i></a>
                                <ul class="submenu">
                            ...
                            <li class="has-submenu"><a href="#"><i class="dripicons-duplicate"></i> Pages <i class="mdi mdi-chevron-down mdi-drop"></i></a>
                                <ul class="submenu megamenu">
                                    <li>
                                        <ul>
    ...
    <footer class="footer">
        <div class="container-fluid">
            <div class="row">
                <div class="col-12">© 2019 Zinzer <span class="d-none d-md-inline-block">- Crafted with <i class="mdi mdi-heart text-danger"></i> by Themesdesign.</span></div>
            </div>
        </div>
    </footer><!-- End Footer -->
    <!-- jQuery  -->
...
<!-- Mirrored from themesdesign.in/zinzer_1/horizontal/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 13 Jun 2019 08:45:22 GMT -->
